...
def parse_global_args(parser):
    ...
    parser.add_argument("--base_model", type=str, default="/you_path/t5-small",help="basic model path")
    parser.add_argument("--phase", type=int, default=None,help="phase path")
    parser.add_argument("--output_dir", type=str,
                        default="/you_path/ckpt/tiger/",
...
def parse_dataset_args(parser):
    ...
    parser.add_argument("--index_file", type=str, default=None, help="the item indices file")
            ...
            if len(GroundTruth[i]) != 0:
                ...
                for j in range(topN[index]):
                    if predictedIndices[i][j] in GroundTruth[i]:
                        ...
                        # if Hit
                        dcg += 1.0/math.log2(j + 2)/col ##for stable result
                        if mrrFlag:
                            userMRR = (1.0/(j+1.0))/col ##for stable result
                            mrrFlag = False
                        userHit += 1/col
